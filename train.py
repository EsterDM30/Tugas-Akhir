...
tags = []
xy = []
# Loop melalui setiap kalimat dalam pola intent
for intent in intents['intents']:
    tag = intent['tag']
    # Menambahkan ke dalam daftar tag
    tags.append(tag)
    for pattern in intent['patterns']:
        # Tokenisasi setiap kata dalam kalimat
        w = tokenize(pattern)
        # Menambahkan ke dalam daftar kata
        all_words.extend(w)
        xy.append((w, tag))

# Lakukan stemming dan ubah setiap kata menjadi huruf kecil
ignore_words = ['?', '.', '!']
